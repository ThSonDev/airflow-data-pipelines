...
dag_id='yolo_pipeline_video2'
video_path='/opt/airflow/projects/vehicle_counting/data/video2.mp4'
kafka_topic='video2_topic'
...
with DAG(
    ...
    producer_task = BashOperator(
        ...
        bash_command=f"""
        timeout 6m python {PRODUCER_SCRIPT_PATH} \
    ...
    cleanup_task = BashOperator(
        ...
        bash_command=(
            ...
            "rm -rf /opt/airflow/static/processed_frames/video2_*;"
            
            # 2. TRUNCATE table using docker exec
            #"docker exec airflow-postgres-1 psql -U airflow -d airflow -c "
            #"'TRUNCATE TABLE yolo_results_video2 RESTART IDENTITY;'"
